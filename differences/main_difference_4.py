...
for bpp_value in bpp_values:
    ...
    axes[1, 1].imshow(binarized_rgb_difference_encoded_dct)
    axes[1, 1].set_title("Binarized Diff DCT encoded Image")
    axes[1, 2].imshow(binarized_rgb_difference_encoded_lsb)
    axes[1, 2].set_title("Binarized Diff LSB encoded Image")
    axes[1, 3].imshow(binarized_rgb_difference_encoded_steganogan)
    axes[1, 3].set_title("Binarized Diff STEGANOGAN encoded Image")
    axes[1, 4].imshow(binarized_rgb_difference_encoded_pvd)
    axes[1, 4].set_title("Binarized Diff PVD encoded Image")

    axes[2, 0].imshow(binarized_gray_difference_original, cmap='gray')
    axes[2, 0].set_title("Binarized Diff Gray Original Image")
    axes[2, 1].imshow(binarized_gray_difference_encoded_dct, cmap='gray')
    axes[2, 1].set_title("Binarized Diff Gray DCT encoded Image")
    axes[2, 2].imshow(binarized_gray_difference_encoded_lsb, cmap='gray')
    axes[2, 2].set_title("Binarized Diff Gray LSB encoded Image")
    axes[2, 3].imshow(binarized_gray_difference_encoded_steganogan, cmap='gray')
    axes[2, 3].set_title("Binarized Diff Gray STEGANOGAN encoded Image")
    axes[2, 4].imshow(binarized_gray_difference_encoded_pvd, cmap='gray')
    axes[2, 4].set_title("Binarized Diff Gray PVD encoded Image")
