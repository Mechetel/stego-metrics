...
for bpp_value in bpp_values:
    ...
    axes[1, 1].imshow(rgb_difference_encoded_lsb)
    axes[1, 1].set_title("Diff LSB encoded Image")
    axes[1, 2].imshow(rgb_difference_encoded_steganogan)
    axes[1, 2].set_title("Diff STEGANOGAN encoded Image")
    axes[1, 3].imshow(rgb_difference_encoded_pvd)
    axes[1, 3].set_title("Diff PVD encoded Image")

    axes[2, 0].imshow(binarized_rgb_difference_original)
    axes[2, 0].set_title("Binarized Diff Original Image")
    axes[2, 1].imshow(binarized_rgb_difference_encoded_lsb)
    axes[2, 1].set_title("Binarized Diff LSB encoded Image")
    axes[2, 2].imshow(binarized_rgb_difference_encoded_steganogan)
    axes[2, 2].set_title("Binarized Diff STEGANOGAN encoded Image")
    axes[2, 3].imshow(binarized_rgb_difference_encoded_pvd)
    axes[2, 3].set_title("Binarized Diff PVD encoded Image")

    axes[3, 0].imshow(gray_difference_original, cmap='gray')
    axes[3, 0].set_title("Diff Gray Original Image")
    axes[3, 1].imshow(gray_difference_encoded_lsb, cmap='gray')
    axes[3, 1].set_title("Diff Gray LSB encoded Image")
    axes[3, 2].imshow(gray_difference_encoded_steganogan, cmap='gray')
    axes[3, 2].set_title("Diff Gray STEGANOGAN encoded Image")
    axes[3, 3].imshow(gray_difference_encoded_pvd, cmap='gray')
    axes[3, 3].set_title("Diff Gray PVD encoded Image")

    axes[4, 0].imshow(binarized_gray_difference_original, cmap='gray')
    axes[4, 0].set_title("Binarized Diff Gray Original Image")
    axes[4, 1].imshow(binarized_gray_difference_encoded_lsb, cmap='gray')
    axes[4, 1].set_title("Binarized Diff Gray LSB encoded Image")
    axes[4, 2].imshow(binarized_gray_difference_encoded_steganogan, cmap='gray')
    axes[4, 2].set_title("Binarized Diff Gray STEGANOGAN encoded Image")
    axes[4, 3].imshow(binarized_gray_difference_encoded_pvd, cmap='gray')
    axes[4, 3].set_title("Binarized Diff Gray PVD encoded Image")
