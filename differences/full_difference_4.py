...
for bpp_value in bpp_values:
    ...
    gray_difference_original           = adjust_brightness_contrast(gray_difference_original,           6.0, 0)
    gray_difference_encoded_dct        = adjust_brightness_contrast(gray_difference_encoded_dct,        6.0, 0)
    gray_difference_encoded_lsb        = adjust_brightness_contrast(gray_difference_encoded_lsb,        6.0, 0)
    gray_difference_encoded_steganogan = adjust_brightness_contrast(gray_difference_encoded_steganogan, 6.0, 0)
    gray_difference_encoded_pvd        = adjust_brightness_contrast(gray_difference_encoded_pvd,        6.0, 0)

    rgb_difference_original            = adjust_brightness_contrast(rgb_difference_original,            6.0, 0)
    rgb_difference_encoded_dct         = adjust_brightness_contrast(rgb_difference_encoded_dct,         6.0, 0)
    rgb_difference_encoded_lsb         = adjust_brightness_contrast(rgb_difference_encoded_lsb,         6.0, 0)
    rgb_difference_encoded_steganogan  = adjust_brightness_contrast(rgb_difference_encoded_steganogan,  6.0, 0)
    rgb_difference_encoded_pvd         = adjust_brightness_contrast(rgb_difference_encoded_pvd,         6.0, 0)
    ...
    axes[0, 1].imshow(rgb_image_encoded_dct)
    axes[0, 1].set_title("DCT encoded Image")
    axes[0, 2].imshow(rgb_image_encoded_lsb)
    axes[0, 2].set_title("LSB encoded Image")
    axes[0, 3].imshow(rgb_image_encoded_steganogan)
    axes[0, 3].set_title("STEGANOGAN encoded Image")
    axes[0, 4].imshow(rgb_image_encoded_pvd)
    axes[0, 4].set_title("PVD encoded Image")

    axes[1, 0].imshow(rgb_difference_original)
    axes[1, 0].set_title("Diff Original Image")
    axes[1, 1].imshow(rgb_difference_encoded_dct)
    axes[1, 1].set_title("Diff DCT encoded Image")
    axes[1, 2].imshow(rgb_difference_encoded_lsb)
    axes[1, 2].set_title("Diff LSB encoded Image")
    axes[1, 3].imshow(rgb_difference_encoded_steganogan)
    axes[1, 3].set_title("Diff STEGANOGAN encoded Image")
    axes[1, 4].imshow(rgb_difference_encoded_pvd)
    axes[1, 4].set_title("Diff PVD encoded Image")

    axes[2, 0].imshow(binarized_rgb_difference_original)
    axes[2, 0].set_title("Binarized Diff Original Image")
    axes[2, 1].imshow(binarized_rgb_difference_encoded_dct)
    axes[2, 1].set_title("Binarized Diff DCT encoded Image")
    axes[2, 2].imshow(binarized_rgb_difference_encoded_lsb)
    axes[2, 2].set_title("Binarized Diff LSB encoded Image")
    axes[2, 3].imshow(binarized_rgb_difference_encoded_steganogan)
    axes[2, 3].set_title("Binarized Diff STEGANOGAN encoded Image")
    axes[2, 4].imshow(binarized_rgb_difference_encoded_pvd)
    axes[2, 4].set_title("Binarized Diff PVD encoded Image")

    axes[3, 0].imshow(gray_difference_original, cmap='gray')
    axes[3, 0].set_title("Diff Gray Original Image")
    axes[3, 1].imshow(gray_difference_encoded_dct, cmap='gray')
    axes[3, 1].set_title("Diff Gray DCT encoded Image")
    axes[3, 2].imshow(gray_difference_encoded_lsb, cmap='gray')
    axes[3, 2].set_title("Diff Gray LSB encoded Image")
    axes[3, 3].imshow(gray_difference_encoded_steganogan, cmap='gray')
    axes[3, 3].set_title("Diff Gray STEGANOGAN encoded Image")
    axes[3, 4].imshow(gray_difference_encoded_pvd, cmap='gray')
    axes[3, 4].set_title("Diff Gray PVD encoded Image")

    axes[4, 0].imshow(binarized_gray_difference_original, cmap='gray')
    axes[4, 0].set_title("Binarized Diff Gray Original Image")
    axes[4, 1].imshow(binarized_gray_difference_encoded_dct, cmap='gray')
    axes[4, 1].set_title("Binarized Diff Gray DCT encoded Image")
    axes[4, 2].imshow(binarized_gray_difference_encoded_lsb, cmap='gray')
    axes[4, 2].set_title("Binarized Diff Gray LSB encoded Image")
    axes[4, 3].imshow(binarized_gray_difference_encoded_steganogan, cmap='gray')
    axes[4, 3].set_title("Binarized Diff Gray STEGANOGAN encoded Image")
    axes[4, 4].imshow(binarized_gray_difference_encoded_pvd, cmap='gray')
    axes[4, 4].set_title("Binarized Diff Gray PVD encoded Image")

    plt.subplots_adjust(left=0.004, bottom=0, right=0.996, top=1, wspace=0.02, hspace=0)
    filename_to_save = "./differences/full/{0}/{1}_diff.png".format(imtxt, bpp_value)
